...
export default {
    ...
    TAGS_TO_REVIEW: "Etiquettes à réviser",
    TAGS_TO_REVIEW_DESC: "Entrer les étiquettes séparées par des espaces ou un retour à la ligne ex : #review #tag2 #tag3.",
    OPEN_RANDOM_NOTE: "Ouvre une note au hasard pour réviser",
    OPEN_RANDOM_NOTE_DESC: "Lorsque vous désactivez cette option, les notes sont ordonnées par importance (PageRank).",
    AUTO_NEXT_NOTE: "Ouvrir la note suivante automatiquement après une révision",
    DISABLE_FILE_MENU_REVIEW_OPTIONS:
        "Désactiver les options de révisions dans le menu de fichier ex : Noter : Facile Correct Difficile",
    DISABLE_FILE_MENU_REVIEW_OPTIONS_DESC:
        "Après désactivation, vous pouvez réviser en utilisant les raccourcis claviers. Recharger Obsidian après changement de cette option.",
